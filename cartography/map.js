...
var geojson = {
  ...
  'features':[
    ...
    { 'type': 'Feature', 'properties': { 'Name': 'Guayaquil, Equador' ,'text': 'Humboldt continues the measurements he started in Callao-Peru and notes the low temperature of the ocean current on the coast of Peru. The current is later named after him "Humboldtstrom".', 'Date': 'Jan 1803', 'url': 'url(https://upload.wikimedia.org/wikipedia/commons/d/d0/Color-yellow.JPG', 'img': './img/70-Humboldt_Guayaquil.jpg'}, 'geometry': { 'type': 'Point', 'coordinates': [ -79.93, -2.16, 0.0 ] } },
    ...
    { 'type': 'Feature', 'properties': { 'Name': 'San Fernando de Apure' ,'text': 'Humboldt arrives in San Fernando on the Río Apure, the capital of the Capuchin Missions in the province of Barinas.', 'Date': '30 de marzo de 1800', 'url': 'url(https://upload.wikimedia.org/wikipedia/commons/d/d0/Color-yellow.JPG', 'img': './img/36-vzla.jpg'}, 'geometry': { 'type': 'Point', 'coordinates': [ -67.47, 7.89, 0.0 ] } },
